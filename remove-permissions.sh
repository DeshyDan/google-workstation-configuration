...
if [ "$#" -ne 2 ]; then
    ...
    echo "Example: ./permissions.sh adg-internal-workstations grant.wilson@africadigitalgroup.com"
    exit 1
fi
PROJECT_ID=$1
USER=$2
...
echo "** Removing IAM permission for user: $USER" 
...
echo "** Successfully removed permission for user: $USER , project:$PROJECT_ID"